...
class Buffer:
	"""Replay buffer for ReW-MPC offline training. Compatible with TD-MPC2 dataset format."""
	...
	def _prepare_batch(self, td):
		"""Post-process sampled batch. Returns (obs, action, reward, terminated, task)."""
	...
	def sample(self):
		"""Sample a batch of trajectory segments (horizon+1 steps each)."""
